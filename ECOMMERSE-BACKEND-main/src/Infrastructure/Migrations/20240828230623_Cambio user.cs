        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductAvaible = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "gaston.koch@hotmail.com", "Koch", "Gaston", "g", new DateTime(2024, 6, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, true, "Pepe@gmail.com", "Gomez", "Pepe", "2", new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 3, true, "juan@gmail.com", "Gomez", "Juan", "3", new DateTime(2024, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 4, true, "ana@gmail.com", "Lopez", "Ana", "4", new DateTime(2024, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 5, true, "luis@gmail.com", "Franco", "Luis", "123", new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 6, true, "pepe@gmail.com", "Moscheti", "Pepe", "876", new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 7, true, "admin@ecommerce.com", "", "admin", "admin", new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 8, true, "luisG@hotmail.com", "Guevara", "Luis", "433", new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 }
                });
